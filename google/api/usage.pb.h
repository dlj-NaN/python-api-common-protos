...
class UsageRule PROTOBUF_FINAL :
...
inline void Usage::_internal_set_producer_notification_channel(const std::string& value) {
  ...
  producer_notification_channel_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void Usage::set_producer_notification_channel(std::string&& value) {
  
  producer_notification_channel_.Set(
...
inline void Usage::set_producer_notification_channel(const char* value) {
  ...
  producer_notification_channel_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.api.Usage.producer_notification_channel)
}
inline void Usage::set_producer_notification_channel(const char* value,
    size_t size) {
  
  producer_notification_channel_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* Usage::_internal_mutable_producer_notification_channel() {
  ...
  return producer_notification_channel_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* Usage::release_producer_notification_channel() {
  ...
  return producer_notification_channel_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
