...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fapi_2fsystem_5fparameter_2eproto = {
  false, false, descriptor_table_protodef_google_2fapi_2fsystem_5fparameter_2eproto, "google/api/system_parameter.proto", 416,
...
void SystemParameter::InternalSwap(SystemParameter* other) {
  ...
  http_header_.Swap(&other->http_header_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  url_query_parameter_.Swap(&other->url_query_parameter_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
