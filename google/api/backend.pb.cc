...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fapi_2fbackend_2eproto = {
  false, false, descriptor_table_protodef_google_2fapi_2fbackend_2eproto, "google/api/backend.proto", 299,
...
void BackendRule::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      ...
      0, static_cast<size_t>(reinterpret_cast<char*>(&min_deadline_) -
      reinterpret_cast<char*>(&deadline_)) + sizeof(min_deadline_));
}
...
void BackendRule::InternalSwap(BackendRule* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(BackendRule, min_deadline_)
      + sizeof(BackendRule::min_deadline_)
