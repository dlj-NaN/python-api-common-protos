...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fapi_2fauth_2eproto = {
  false, false, descriptor_table_protodef_google_2fapi_2fauth_2eproto, "google/api/auth.proto", 678,
...
void AuthProvider::InternalSwap(AuthProvider* other) {
  ...
  audiences_.Swap(&other->audiences_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
void OAuthRequirements::InternalSwap(OAuthRequirements* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  canonical_scopes_.Swap(&other->canonical_scopes_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
void AuthRequirement::InternalSwap(AuthRequirement* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  provider_id_.Swap(&other->provider_id_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  audiences_.Swap(&other->audiences_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
