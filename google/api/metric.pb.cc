...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fapi_2fmetric_2eproto = {
  false, false, descriptor_table_protodef_google_2fapi_2fmetric_2eproto, "google/api/metric.proto", 754,
...
void MetricDescriptor::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      reinterpret_cast<char*>(&metric_kind_) - reinterpret_cast<char*>(this)),
...
void MetricDescriptor::InternalSwap(MetricDescriptor* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MetricDescriptor, value_type_)
      + sizeof(MetricDescriptor::value_type_)
      - PROTOBUF_FIELD_OFFSET(MetricDescriptor, metric_kind_)>(
          reinterpret_cast<char*>(&metric_kind_),
          reinterpret_cast<char*>(&other->metric_kind_));
}
