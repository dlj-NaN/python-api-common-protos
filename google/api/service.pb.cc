...
const char descriptor_table_protodef_google_2fapi_2fservice_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_google_2fapi_2fservice_2eproto_deps[21] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fapi_2fservice_2eproto = {
  false, false, descriptor_table_protodef_google_2fapi_2fservice_2eproto, "google/api/service.proto", 1727,
  &descriptor_table_google_2fapi_2fservice_2eproto_once, descriptor_table_google_2fapi_2fservice_2eproto_sccs, descriptor_table_google_2fapi_2fservice_2eproto_deps, 1, 21,
...
void Service::clear_config_version() {
  if (GetArena() == nullptr && config_version_ != nullptr) {
...
void Service::clear_backend() {
  if (GetArena() == nullptr && backend_ != nullptr) {
    delete backend_;
  }
  backend_ = nullptr;
}
...
void Service::clear_quota() {
  if (GetArena() == nullptr && quota_ != nullptr) {
    delete quota_;
  }
  quota_ = nullptr;
}
void Service::clear_authentication() {
  if (GetArena() == nullptr && authentication_ != nullptr) {
...
void Service::clear_monitoring() {
  if (GetArena() == nullptr && monitoring_ != nullptr) {
    delete monitoring_;
  }
  monitoring_ = nullptr;
}
void Service::clear_system_parameters() {
  if (GetArena() == nullptr && system_parameters_ != nullptr) {
    delete system_parameters_;
  }
  system_parameters_ = nullptr;
}
void Service::clear_source_info() {
  if (GetArena() == nullptr && source_info_ != nullptr) {
    delete source_info_;
  }
...
void Service::InternalSwap(Service* other) {
  ...
  producer_project_id_.Swap(&other->producer_project_id_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
