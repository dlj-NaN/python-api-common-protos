...
class MetricRule PROTOBUF_FINAL :
...
class QuotaLimit PROTOBUF_FINAL :
...
inline void QuotaLimit::_internal_set_duration(const std::string& value) {
  ...
  duration_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void QuotaLimit::set_duration(const char* value) {
  ...
  duration_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.api.QuotaLimit.duration)
}
inline void QuotaLimit::set_duration(const char* value,
    size_t size) {
  
  duration_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* QuotaLimit::_internal_mutable_duration() {
  ...
  return duration_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* QuotaLimit::release_duration() {
  // @@protoc_insertion_point(field_release:google.api.QuotaLimit.duration)
  return duration_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
