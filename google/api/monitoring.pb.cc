...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fapi_2fmonitoring_2eproto = {
  false, false, descriptor_table_protodef_google_2fapi_2fmonitoring_2eproto, "google/api/monitoring.proto", 433,
...
void Monitoring_MonitoringDestination::InternalSwap(Monitoring_MonitoringDestination* other) {
  ...
  monitored_resource_.Swap(&other->monitored_resource_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
