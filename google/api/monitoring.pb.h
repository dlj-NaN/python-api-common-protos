...
class Monitoring_MonitoringDestination PROTOBUF_FINAL :
...
class Monitoring PROTOBUF_FINAL :
...
inline void Monitoring_MonitoringDestination::_internal_set_monitored_resource(const std::string& value) {
  ...
  monitored_resource_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void Monitoring_MonitoringDestination::set_monitored_resource(std::string&& value) {
  
  monitored_resource_.Set(
...
inline void Monitoring_MonitoringDestination::set_monitored_resource(const char* value) {
  ...
  monitored_resource_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.api.Monitoring.MonitoringDestination.monitored_resource)
}
inline void Monitoring_MonitoringDestination::set_monitored_resource(const char* value,
    size_t size) {
  
  monitored_resource_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* Monitoring_MonitoringDestination::_internal_mutable_monitored_resource() {
  ...
  return monitored_resource_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* Monitoring_MonitoringDestination::release_monitored_resource() {
  ...
  return monitored_resource_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
