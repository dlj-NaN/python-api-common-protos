...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_google_2ftype_2fcalendar_5fperiod_2eproto(&descriptor_table_google_2ftype_2fcalendar_5fperiod_2eproto);
namespace google {
namespace type {
