...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2ftype_2fpostal_5faddress_2eproto = {
  false, false, descriptor_table_protodef_google_2ftype_2fpostal_5faddress_2eproto, "google/type/postal_address.proto", 433,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_google_2ftype_2fpostal_5faddress_2eproto(&descriptor_table_google_2ftype_2fpostal_5faddress_2eproto);
namespace google {
namespace type {
...
PostalAddress::PostalAddress(const PostalAddress& from)
  ...
  if (!from._internal_sorting_code().empty()) {
    sorting_code_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_sorting_code(), 
      GetArena());
  }
  ...
  if (!from._internal_sublocality().empty()) {
    sublocality_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_sublocality(), 
      GetArena());
  }
