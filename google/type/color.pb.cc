...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2ftype_2fcolor_2eproto = {
  false, false, descriptor_table_protodef_google_2ftype_2fcolor_2eproto, "google/type/color.proto", 271,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_google_2ftype_2fcolor_2eproto(&descriptor_table_google_2ftype_2fcolor_2eproto);
namespace google {
namespace type {
